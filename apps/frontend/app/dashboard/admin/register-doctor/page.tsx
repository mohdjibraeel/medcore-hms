...
export default function RegisterDoctorPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMessage(
        `Dr. ${firstName} ${lastName} was registered successfully.`,
      );
      setFirstName("");
      setLastName("");
      setEmail("");
  ...
  if (!hospitalId) {
    return (
      <p className="text-sm text-red-600">
        Your account isn&apos;t assigned to a hospital, so you can&apos;t
        register doctors.
      </p>
    );
  }
      ...
      <div className="mt-6 space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-zinc-500">
            At least 6 characters. Share this with the doctor directly.
          </p>
        </div>
        ...
        <Button
          type="button"
          disabled={!isValid || createDoctor.isPending}
